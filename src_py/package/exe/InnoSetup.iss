...
OutputDir=E:\Desktop\generateTemplate\build
OutputBaseFilename=pywebview-toolkit-V1.0.0_Windows
SetupIconFile=E:\Desktop\generateTemplate\src_py\icon\logo.ico
Compression=lzma
...
[Files]
Source: "E:\Desktop\generateTemplate\build\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
